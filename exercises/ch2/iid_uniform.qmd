...
$$
Since we were lucky to obtain a wide range of the data that is close to $1$ (difference between maximum and minimum observation: $2.05-1.1 = 0.95$), the Bayesian gets a tight posterior which is uniform between $1.55$ and $1.60$. The posterior is plotted here:
```{r}
x = c(1.10, 2.05, 1.21)
