...
**a)** 
{{< include /exercises/book_exercises/oneparam/truncated_normal_a.tex >}}

::: {#q:iid_truncated_normal_a .callout-note icon="false" collapse="true"}
## Solution
...
**b)** 
{{< include /exercises/book_exercises/oneparam/truncated_normal_b.tex >}}

::: {#q:iid_truncated_normal_b .callout-note icon="false" collapse="true"}
## Solution
...
**c)** 
{{< include /exercises/book_exercises/oneparam/truncated_normal_c.tex >}}

::: {#q:iid_truncated_normal_c .callout-note icon="false" collapse="true"}
## Solution
...
We are now ready for the final piece of information: the two truncated observations. We do not know their exact values, but we \textbf{do} know that they were equal to or larger than $3$. This is important information which we cannot ignore. The likelihood of these two observations (let’s call them $z_{1}$ and $z_{2}$) is
    \begin{align*}
